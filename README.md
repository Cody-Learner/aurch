...
# _'set -u' Will not allow printing vars to file, lines 48-58.	Appending '-' to all vars fixed issue._ <br>
# _'set -u' Will not allow using positional parameters.		Appending '-' to all positional parameters fixed issue._ <br>
# _'set -u' Exits on: "/path/to/script/ line 147: $2: unbound variable" <br>
# _Line 147, '$2' is part of an awk command inside an "EOF [here doc]" and not a bash positional parameter. (A bash bug?)_ <br>
# _Rewrote 'fetch_pkg' function lines ~143-159, to accommodate 'set -u' by removing awk from the here doc._ <br>
<br>
